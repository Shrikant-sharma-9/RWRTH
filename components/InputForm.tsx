  ...
  <div>
    ...
    <div className="mt-1 relative rounded-md shadow-sm">
      <input
        ...
        className="bg-blue-50 focus:bg-white focus:ring-blue-500 focus:border-blue-500 block w-full pr-12 sm:text-sm border-gray-300 rounded-md transition-colors duration-200"
        required
